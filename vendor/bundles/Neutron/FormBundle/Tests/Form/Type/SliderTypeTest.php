...
class SliderTypeTest extends TypeTestCase
{
    ...
    {
        $form = $this->factory->create('neutron_slider');
    ...
    {
        $form = $this->factory->create('neutron_slider', null, array('configs' => array('orientation' => 'vertical')));
        $view = $form->createView();
        $configs = $view->vars['configs'];
        $this->assertSame(array(
            'tpl' => 'slider.value: __value__',
    ...
    public function testWithInvalidConfigs()
    {
        ...
        $form = $this->factory->create('neutron_slider', null, array('configs' => array('range' => 'invalid')));
    }
